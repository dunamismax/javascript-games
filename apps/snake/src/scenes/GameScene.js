...
export class GameScene extends Phaser.Scene {
  ...
  createUI() {
    ...
    this.pauseText = this.add.text(320, 320, 'PAUSED', {
      fontSize: '48px',
      fontFamily: 'Arial',
      color: '#ffffff'
    }).setOrigin(0.5);
    ...
    this.gameOverText = this.add.text(320, 320, 'GAME OVER', {
      fontSize: '48px',
      fontFamily: 'Arial',
      color: '#ff0000'
    }).setOrigin(0.5);
  ...
  drawFood() {
    ...
    this.foodGraphics.fillCircle(x + this.gridSize / 2, y + this.gridSize / 2, this.gridSize / 2 - 2);
