export class GameScene extends Phaser.Scene {
  constructor() {
    ...
    this.tetrominoes = {
      ...
      O: { blocks: [[1,1],[1,1]], color: 0xFFFF00 },
      T: { blocks: [[0,1,0],[1,1,1]], color: 0x800080 },
      S: { blocks: [[0,1,1],[1,1,0]], color: 0x00FF00 },
      Z: { blocks: [[1,1,0],[0,1,1]], color: 0xFF0000 },
      J: { blocks: [[1,0,0],[1,1,1]], color: 0x0000FF },
      L: { blocks: [[0,0,1],[1,1,1]], color: 0xFFA500 }
    };
  ...
  spawnTetromino() {
    ...
    if (!this.isValidPosition(this.currentTetromino.blocks, this.currentX, this.currentY)) {
      this.endGame();
    }
  }
