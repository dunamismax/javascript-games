export class ScoreDisplay extends Phaser.GameObjects.Container {
  ...
  createDisplay() {
    const textContent = this.options.label ? `${this.options.label}: ${this.formatScore(this.displayScore)}` : this.formatScore(this.displayScore);
    ...
    if (this.options.backgroundColor) {
      ...
      this.background.fillStyle(Phaser.Display.Color.HexStringToColor(this.options.backgroundColor).color);
  ...
  updateDisplay() {
    ...
    const textContent = this.options.label ? `${this.options.label}: ${this.formatScore(score)}` : this.formatScore(score);
